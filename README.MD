...
The file is called findme.txt.  It is somewhere in the filesystem but we need to find it first.
...
Redirection allows you to send the output of a command to file.
